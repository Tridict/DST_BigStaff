...
这是一把具备多用途的全能大法杖，同时也是一把很酷炫的武器！有了这把大法杖，你基本上就不需要换你的手持装备啦！它具备砍树、挖矿、锤子、铲子、捕虫网、犁地锄、照明、步行手杖、传送法杖等多种生活功能，同时也有多种武器效果可选（见选项菜单）。（提示：贪心是会有代价的哦！）]]
author = "Roomcar & Cora"
version = "1.0.0"
